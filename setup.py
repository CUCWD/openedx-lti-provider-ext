#!/usr/bin/env python
"""
Package metadata for openedx_lti_provider_ext.
"""
import os
import re
import sys
...
VERSION = get_version('openedx_lti_provider_ext', '__init__.py')
...
setup(
    name='openedx-lti-provider-ext',
    version=VERSION,
    description="""SkilRedi changes for LMS LTI Provider application.""",
    long_description=README + '\n\n' + CHANGELOG,
    author='Zachary Trabookis',
    author_email='ztraboo@clemson.edu',
    url='https://github.com/CUCWD/openedx-lti-provider-ext',
    packages=find_packages(
        include=['openedx_lti_provider_ext', 'openedx_lti_provider_ext.*'],
        exclude=["*tests"],
    ),
