...
"""
openedx-lti-provider-ext documentation build configuration file.
...
html_context = {
    ...
    "github_repo": 'openedx-lti-provider-ext',  # Repo name
...
#
html_theme_options = {
    "repository_url": "https://github.com/CUCWD/openedx-lti-provider-ext",
...
#
# html_title = 'openedx-lti-provider-ext v0.1.1'
...
texinfo_documents = [
    (top_level_doc, project_title, documentation_title,
     author, project_title, 'SkilRedi changes for LMS LTI Provider application.',
     'Miscellaneous'),
]
